...
public:
    ...
    void setupUi(QWidget *connect_db)
    {
        ...
        font2.setBold(true);
        connect_but->setFont(font2);
        connect_but->setFocusPolicy(Qt::NoFocus);
        connect_but->setStyleSheet(QString::fromUtf8("background-color: #4CAF50; color: white; padding: 10px; border: none; border-radius: 5px;"));
        QIcon icon;
        icon.addFile(QString::fromUtf8("icons/connect_icon.png"), QSize(), QIcon::Normal, QIcon::Off);
        connect_but->setIcon(icon);

        gridLayout->addWidget(connect_but, 7, 0, 1, 2);

        exit_but = new QPushButton(layoutWidget);
        exit_but->setObjectName("exit_but");
        exit_but->setFont(font2);
        exit_but->setStyleSheet(QString::fromUtf8("background-color: #F44336; color: white; padding: 10px; border: none; border-radius: 5px;"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8("icons/exit_icon.png"), QSize(), QIcon::Normal, QIcon::Off);
        exit_but->setIcon(icon1);

        gridLayout->addWidget(exit_but, 8, 0, 1, 2);
    ...
    void retranslateUi(QWidget *connect_db)
    {
        ...
        server_name_lineedit->setText(QCoreApplication::translate("connect_db", "NURZAMAT\\SQLEXPRESS", nullptr));
        ...
        db_name_lineedit->setText(QCoreApplication::translate("connect_db", "AutoSchool", nullptr));
        ...
        login_lineedit->setText(QCoreApplication::translate("connect_db", "sa", nullptr));
        ...
        pass_lineedit->setText(QCoreApplication::translate("connect_db", "123", nullptr));
        pass_lineedit->setPlaceholderText(QCoreApplication::translate("connect_db", "Enter password", nullptr));
        connect_but->setText(QCoreApplication::translate("connect_db", "Connect", nullptr));
        exit_but->setText(QCoreApplication::translate("connect_db", "Exit", nullptr));
    } // retranslateUi
